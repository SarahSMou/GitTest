...
depo_front_lidar_dist = None          # in cm
depo_back_lidar_dist = None           # in cm
...
'''
def send_drive_command(driveMode, speed):
    outmsg = Drive_Vector()
    outmsg.offset_driveMode = driveMode
...
def main():
	...
	smach.StateMachine.add('state0', state0(), transitions = {'state2': 'state2'})
